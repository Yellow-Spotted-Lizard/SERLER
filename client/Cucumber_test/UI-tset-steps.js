const expect = require('chai').expect; module.exports = function () {
    this.When(/^I search Google for "([^"]*)"$/, (text) =>{ return helpers.loadPage('https://google.com')
    .then( () => {
    ...
    this.When(/^I enter "([^"]*)" in input$/, function(expression){ console.log("expression is ",expression);
